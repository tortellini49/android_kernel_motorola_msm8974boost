...
#define INTELLI_HOTPLUG			"intelli_hotplug"
#define INTELLI_HOTPLUG_MAJOR_VERSION	5
#define INTELLI_HOTPLUG_MINOR_VERSION	4
...
static int __init intelli_plug_init(void)
{
	...
	pr_info("intelli_hotplug: version %d.%d\n",
		 INTELLI_HOTPLUG_MAJOR_VERSION,
		 INTELLI_HOTPLUG_MINOR_VERSION);
...
MODULE_DESCRIPTION("'intelli_hotplug' - An intelligent CPU hotplug driver for "
